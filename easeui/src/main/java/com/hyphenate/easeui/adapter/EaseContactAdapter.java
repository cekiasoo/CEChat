...
public class EaseContactAdapter extends ArrayAdapter<EMGroup> implements SectionIndexer{
    private static final String TAG = "ContactAdapter";
    List<String> list;
    List<EMGroup> userList;
    List<EMGroup> copyUserList;
    ...
    public EaseContactAdapter(Context context, int resource, List<EMGroup> objects) {
        super(context, resource, objects);
        this.res = resource;
        this.userList = objects;
        copyUserList = new ArrayList<EMGroup>();
    ...
    protected class  MyFilter extends Filter{
        ...
        protected synchronized void publishResults(CharSequence constraint,
            ...
            userList.clear();
            userList.addAll((List<EMGroup>)results.values);
