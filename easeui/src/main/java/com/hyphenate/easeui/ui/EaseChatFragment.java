...
//    protected int[] itemStrings = { R.string.attach_take_pic, R.string.attach_picture, R.string.attach_location };
    ...
    public static EaseChatFragment newInstance(int pChatType, String pUserId) {
        EaseChatFragment fragment = new EaseChatFragment();
        Bundle bundle = new Bundle();
        bundle.putInt(EaseConstant.EXTRA_CHAT_TYPE, pChatType);
        bundle.putString(EaseConstant.EXTRA_USER_ID, pUserId);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        Log.v(TAG, "chatType = " + chatType + ", toChatUsername = " + toChatUsername);
...
//        messageList.setAvatarShape(1);
    ...
    protected void setUpView() {
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            ...
            if(EaseUserUtils.getUserInfo(toChatUsername) != null){
                EMGroup user = EaseUserUtils.getUserInfo(toChatUsername);
                if (user != null) {
            ...
            if (chatType == EaseConstant.CHATTYPE_GROUP) {
                //group chat
                com.hyphenate.chat.EMGroup group = EMClient.getInstance().groupManager().getGroup(toChatUsername);
                if (group != null) {
    ...
    protected void inputAtUsername(String username, boolean autoAddAtSymbol){
        ...
        EMGroup user = EaseUserUtils.getUserInfo(username);
        if (user != null){
    ...
    public void camera() {
        ...
        if (EaseCommonUtils.isSdcardExist()) {
            ...
            File file = new File(PathUtil.getInstance().getImagePath().getPath());
            if(!file.exists()){
                file.mkdirs();
            }
            Uri pictureUri;
            File pictureFile = new File(file, EMClient.getInstance().getCurrentUser()
                    + System.currentTimeMillis() + ".jpg");
