...
public class EaseCommonUtils {
     ...
     * @param user
     */
    public static void setUserInitialLetter(EMGroup user) {
     ...
     * @param user
     */
    public static String getInitialLetter(com.hyphenate.chat.EMGroup user) {
        final String DefaultLetter = "#";
        String letter = DefaultLetter;
        ...
        if ( !TextUtils.isEmpty(user.getGroupName()) ) {
            letter = new GetInitialLetter().getLetter(user.getGroupName());
            return letter;
        }
        return DefaultLetter;
    }
