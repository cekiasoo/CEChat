...
public class EaseContactList extends RelativeLayout {
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case MSG_UPDATE_LIST:
                if(adapter != null){
                	adapter.clear();
                	adapter.addAll(new ArrayList<EMGroup>(contactList));
     ...
     * init view
     */
    public void init(List<EMGroup> contactList){
    	this.contactList = contactList;
        adapter = new EaseContactAdapter(context, 0, new ArrayList<EMGroup>(contactList));
