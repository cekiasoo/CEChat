...
import com.hyphenate.easeui.adapter.EaseGroupAdapter;

import java.util.ArrayList;
import java.util.List;

public class EaseGroupList extends RelativeLayout {
    protected static final String TAG = EaseGroupList.class.getSimpleName();

    protected Context context;
    protected ListView listView;
    protected EaseGroupAdapter adapter;
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case MSG_UPDATE_LIST:
                if(adapter != null){
                	adapter.clear();
                	adapter.addAll(new ArrayList<EMGroup>(groupList));
    ...
    public EaseGroupList(Context context) {
        super(context);
        init(context, null);
    }

    public EaseGroupList(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public EaseGroupList(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs);
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        listView = (ListView)findViewById(R.id.rv_group_member_list);
     ...
     * init view
     */
    public void init(List<EMGroup> groupList){
    	this.groupList = groupList;
        adapter = new EaseGroupAdapter(context, 0, new ArrayList<EMGroup>(groupList));
