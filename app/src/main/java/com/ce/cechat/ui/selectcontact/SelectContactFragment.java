...
public class SelectContactFragment extends InjectFragment<SelectContactPresenter>
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (mArgType == TYPE_CREATE_GROUP) {
            ...
            lvContacts.setAdapter(adapter);
            sidebar.setListView(lvContacts);
            mPresenter.getGroupDetail(mArgGroupId);
        }
    ...
    private void createGroup() {
        ...
        options.style = mPresenter.getGroupStyle(mArgGroupStyle);
    ...
    public void getGroupDetailSuccess(EMGroup value) {
        LinkedList<User> contact = mPresenter.getAllNotInGroupContact(value);
        refresh(contact);
    }
