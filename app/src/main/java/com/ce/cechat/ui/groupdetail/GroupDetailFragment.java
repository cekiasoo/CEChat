...
import com.ce.cechat.ui.chat.GroupMemberAdapter;
...
public class GroupDetailFragment extends InjectFragment<GroupDetailPresenter>
        ...
        GroupMemberAdapter.OnAddClickListener,
        GroupMemberAdapter.OnMemberClickListener {
    ...
    protected void initView(View view) {
        ...
        mPresenter.getGroupName(mGroupId);
    ...
    public void getGroupDetailSuccess(EMGroup pGroup) {
        mGroupDetail = pGroup;
        List<GroupMember> allMember = mPresenter.getGroupAllMember(pGroup);
        List<GroupMember> allAdmin = mPresenter.getGroupAllAdmin(pGroup);
        GroupMember owner = mPresenter.getOwner(pGroup);
        setGroupName(pGroup.getGroupName());
        mPresenter.isOwnerOrAdmin(pGroup);
        ...
        hideProgress();
        isOwner = mPresenter.isGroupOwner(owner.getHyphenateId());
        isLoading = false;
        stopRefreshing();
    }
            ...
            new AlertDialog.Builder(getContext())
                    ...
                    .setPositiveButton(R.string.confirm_destroy, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            mPresenter.destroyGroup(mGroupId);
                        }
                    })
        ...
        if (getContext() != null) {
            new AlertDialog.Builder(getContext())
                    ...
                    .setPositiveButton(R.string.confirm_leave, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            mPresenter.leaveGroup(mGroupId);
                        }
                    })
                    .setNegativeButton(R.string.cancels, new DialogInterface.OnClickListener() {
                        @Override
