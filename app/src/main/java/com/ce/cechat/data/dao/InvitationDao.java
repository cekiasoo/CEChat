...
public class InvitationDao extends AbstractDao{
     ...
     * @return 成功返回true 失败返回false
     */
    public boolean updateContactInvitationStatus(int pStatus, String pHyphenateId) {

        Log.v(TAG, "pStatus = " + pStatus + ", pHyphenateId = " + pHyphenateId);
     ...
     * @return 成功返回true 失败返回false
     */
    public boolean updateGroupInvitationStatus(int pStatus, String pHyphenateId) {
