...
import static com.ce.cechat.model.bean.Invitation.InvitationStatus.GROUP_ACCEPT_APPLICATION;
import static com.ce.cechat.model.bean.Invitation.InvitationStatus.GROUP_ACCEPT_INVITE;
import static com.ce.cechat.model.bean.Invitation.InvitationStatus.GROUP_REFUSE_APPLICATION;
import static com.ce.cechat.model.bean.Invitation.InvitationStatus.GROUP_REFUSE_INVITE;
import static com.ce.cechat.model.bean.Invitation.InvitationStatus.INVITE_ACCEPT;
import static com.ce.cechat.model.bean.Invitation.InvitationStatus.INVITE_REFUSE;
 ...
 *
 */
public class InviteBiz implements IInviteBiz {
    ...
    public void updateAcceptInviteContactStatus(Invitation pInvitation) {
        DbBiz.newInstance()
                .getDbManager()
                .getInvitationDao()
                .updateInvitationStatus(INVITE_ACCEPT, pInvitation.getUser().getHyphenateId());
    }
    ...
    public void updateAcceptInviteGroupStatus(Invitation pInvitation) {
        DbBiz.newInstance()
                .getDbManager()
                .getInvitationDao()
                .updateInvitationStatus(GROUP_ACCEPT_INVITE, pInvitation.getGroup().getGroupId());
    }
    ...
    public void updateAcceptApplicationGroupStatus(Invitation pInvitation) {
        DbBiz.newInstance()
                .getDbManager()
                .getInvitationDao()
                .updateInvitationStatus(GROUP_ACCEPT_APPLICATION, pInvitation.getGroup().getGroupId());
    }
    ...
    public void updateRefuseInviteContactStatus(Invitation pInvitation) {
        DbBiz.newInstance()
                .getDbManager()
                .getInvitationDao()
                .updateInvitationStatus(INVITE_REFUSE, pInvitation.getUser().getHyphenateId());
    }
    ...
    public void updateRefuseInviteGroupStatus(Invitation pInvitation) {
        DbBiz.newInstance()
                .getDbManager()
                .getInvitationDao()
                .updateInvitationStatus(GROUP_REFUSE_INVITE, pInvitation.getGroup().getGroupId());
    }
    ...
    public void updateRefuseApplicationGroupStatus(Invitation pInvitation) {
        DbBiz.newInstance()
                .getDbManager()
                .getInvitationDao()
                .updateInvitationStatus(GROUP_REFUSE_APPLICATION, pInvitation.getGroup().getGroupId());
    }
