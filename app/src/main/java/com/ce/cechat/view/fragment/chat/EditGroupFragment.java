...
import com.ce.cechat.presenter.EditGroupMemberPresenter;
import com.ce.cechat.utils.ErrorCode;
import com.ce.cechat.view.adapter.GroupMemberRecyclerViewAdapter;
...
public class EditGroupFragment extends BaseFragment
        implements GroupMemberRecyclerViewAdapter.OnListFragmentInteractionListener, IEditGroupMemberView {
    ...
    private EditGroupMemberPresenter mEditGroupMemberPresenter;
    ...
    public EditGroupFragment() {
        mEditGroupMemberPresenter = new EditGroupMemberPresenter(this);
    }
    ...
    protected void initView(View view) {
        ...
        mEditGroupMemberPresenter.getGroupDetail(mGroupId);
    }
            ...
            new AlertDialog.Builder(getContext())
                    ...
                    .setPositiveButton(R.string.confirm_delete, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            mEditGroupMemberPresenter.deleteGroupMembers(mGroupId, item.getHyphenateId());
                        }
                    })
        ...
        if (getContext() != null) {
            new AlertDialog.Builder(getContext())
                    ...
                    .setPositiveButton(R.string.confirm_cancel, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            mEditGroupMemberPresenter.cancelGroupAdmin(mGroupId, item.getHyphenateId());
                        }
                    })
                    .setNegativeButton(R.string.cancels, new DialogInterface.OnClickListener() {
                        @Override
        ...
        if (getContext() != null) {
            new AlertDialog.Builder(getContext())
                    ...
                    .setPositiveButton(R.string.confirm_set, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            mEditGroupMemberPresenter.setGroupAdmin(mGroupId, item.getHyphenateId());
                        }
                    })
                    .setNegativeButton(R.string.cancels, new DialogInterface.OnClickListener() {
                        @Override
    ...
    private void updateAdapter(EMGroup pGroup) {
        List<GroupMember> allMembers = mEditGroupMemberPresenter.getGroupAllMembers(pGroup);
        boolean owner = mEditGroupMemberPresenter.isGroupOwner(pGroup);
        boolean admin = mEditGroupMemberPresenter.isGroupAdmin(pGroup);
