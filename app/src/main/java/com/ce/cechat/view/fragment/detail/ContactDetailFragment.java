...
import com.ce.cechat.presenter.DetailPresenter;
import com.ce.cechat.utils.ErrorCode;
import com.ce.cechat.view.adapter.DetailMenuAdapter;
 ...
 */
public class ContactDetailFragment extends BaseFragment implements AdapterView.OnItemClickListener, IContactDetailView {
        ...
        new AlertDialog.Builder(getContext())
                ...
                .setPositiveButton(R.string.confirm_delete, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        mDetailPresenter.deleteContact(mUser.getUsername());
                    }
                })
