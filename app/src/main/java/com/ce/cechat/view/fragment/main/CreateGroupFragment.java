...
import com.ce.cechat.presenter.CreateGroupPresenter;
 ...
 */
public class CreateGroupFragment extends BaseFragment implements ICreateGroupView {
    ...
    public void onSelectContactClicked() {
        if (mCreateGroupPresenter.isGroupNameEmpty()) {
            return;
        }
        if (mCreateGroupPresenter.isGroupDescriptionEmpty()) {
            return;
        }
        if (mCreateGroupPresenter.isGroupReasonEmpty()) {
            return;
        }
        EMGroupManager.EMGroupStyle style = mCreateGroupPresenter.getGroupStyle();
    ...
    private void submit() {
        ...
        options.style = mCreateGroupPresenter.getGroupStyle();

        mCreateGroupPresenter.createGroup(getGroupName(), getGroupDescription(), new String[]{}, getGroupReason(), options);
